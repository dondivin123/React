...
const Hero = () => {
  return (
    <main id="home" className="flex items-center h-[80vh] gap-6 px-5 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
      ...
      <h1 className="font-extrabold text-4xl">Hi, I&apos;m Don Divin</h1>
      <p>
      a passionate Frontend Developer who turns design ideas into 
      ...
      <button onClick={() => ("engaged Me")} className="bg-yellow-500 text-white text-[18px] py-4 px-12 rounded-full hover:bg-blue-800
          focus:ring-[2px] focus:ring-red-700 focus:ring-offset-[1px] outline-none">engaged Me</button>
      </div>
      <div className="w-1/3 flex justify-center">
      <img src={logo} alt="logo.jpg" className="w-[400px] h-[400px] object-cover rounded-full shadow-lg"/>
      </div>
    </main>
  )
}
